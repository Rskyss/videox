...
def proxy_direct_download(video_url: str, filename: str):
    ...
    try:
        # 根据视频URL选择合适的Referer
        referer = 'https://www.douyin.com/'  # 默认使用抖音
        cookies_dict = {}
        
        if 'xhscdn.com' in video_url or 'xiaohongshu.com' in video_url:
            referer = 'https://www.xiaohongshu.com/'
        elif 'bilibili.com' in video_url or 'bilivideo.com' in video_url:
            referer = 'https://www.bilibili.com/'
        elif 'ixigua.com' in video_url or 'ixiguavideo.com' in video_url:
            referer = 'https://www.ixigua.com/'
        elif 'kuaishou.com' in video_url or 'kuaishoucdn.com' in video_url:
            referer = 'https://www.kuaishou.com/'
        elif 'tiktok' in video_url.lower():
...
def download_with_ytdlp(video_url: str, filename: str):
    ...
    try:
        ...
        if result.returncode != 0:
            ...
            sys.stderr.flush()
            raise Exception(f"yt-dlp下载失败: {result.stderr[:500]}")
        ...
        if not os.path.exists(temp_file):
            ...
            for ext in ['.mp4', '.mkv', '.webm', '.flv']:
                ...
                raise Exception(f"下载的文件不存在: {temp_file}")
