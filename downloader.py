...
# 注: 以下模块已废弃,DouyinService已支持纯后端下载
# from douyin_helper import DouyinDownloadHelper
# from douyin_online_parser import DouyinOnlineParser
...
class VideoDownloader:
    ...
    def _get_platform_display_name(self, extractor: str) -> str:
        ...
        return platform_map.get(extractor, extractor or '未知平台')
