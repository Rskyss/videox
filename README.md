...
2. 点击「解析」  
3. 确认标题、时长、大小后点击「下载」  
4. **在浏览器自己的下载栏查看进度**（不是页面上的假进度条）

说明：
- 普通直链：浏览器直接开始下载，进度看浏览器下载栏  
- 需要合并音视频的（如部分 B 站 / YouTube）：服务器会先合并，再交给浏览器下载；合并期间按钮会提示「准备下载中」
...
**web 分支** · 浏览器原生下载进度（去掉页面服务器进度条）  
主干 `main` 仍保留统一后台任务进度方案，本分支面向更好的直下体验。
